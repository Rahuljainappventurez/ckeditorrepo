...
const UnPublishedQuestion = ({ type }) => {
                ...
                <Grid className='table-wrapper-with-text'>
                    <Grid className='table-heading-text-top-container'>
                        <p className='main-heading-with-back-button'><ArrowBackIos onClick={() => navigate(-1)} />
                            <span>{(type === 'DPP') ? 'List of Unpublished Questions'
                                : (type === 'flashcard') ? 'List of Unpublished Flashcards'
                                    : 'List of Unpublished Assignments'}</span>
                        </p>
...
export default UnPublishedQuestion