...
import { tableNCERTAllColumns } from 'constants/TableConstants'
import { tableNCERTDummyData } from 'constants/TableConstants'

const NCERTManagement = () => {
            ...
            <Grid className='page-main-container-layout'>
                ...
                <Grid className='table-wrapper-with-text'>
                    ...
                    <CustomAdvanceTable
                        ...
                        allColumns={tableNCERTAllColumns}
                        tableData={tableNCERTDummyData}
                        isLoading={false}
...
export default NCERTManagement