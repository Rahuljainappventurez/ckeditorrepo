...
const ViewFlashcardsCreatorApproverEditor = () => {
    ...
    console.log(tableViewType, 'ceueu3iefneifn')
                    ...
                    </Grid>
                    {
                        (tableViewType === 'list') ?
                            <CustomAdvanceTable
                                ...
                                tableData={tableViewFlashcardsCreatorDummyData}
                                isLoading={false}
...
export default ViewFlashcardsCreatorApproverEditor