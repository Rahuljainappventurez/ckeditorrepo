...
function RedirectBoxDialog({ open, setOpen }) {
    ...
    return (
        ...
        >
            <Grid className='view-remarks-dialog-main-container'>
                ...
                <Grid className='redirect-box-dialog-content-box'>
                    <Grid className='redirect-box-dialog-text'>
                        <h4>Question saved successfully.</h4>
                        ...
                        <Grid display={'flex'} justifyContent={'center'}>
                            <ArgonButton
                                ...
                                color={'dark'}
                                disableHover={true}
                                onClick={() => navigate(routerConstants?.addQuestionRoute)}
                            >
...
RedirectBoxDialog.propTypes = {
    open: PropTypes.bool.isRequired,
    setOpen: PropTypes.func.isRequired,
};

export default React.memo(RedirectBoxDialog)
