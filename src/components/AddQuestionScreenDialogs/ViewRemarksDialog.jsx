...
import './view-remarks-dialog.scss';
import { Grid } from '@mui/material';
import PropTypes from 'prop-types';
import { tableViewRemarksAllColumns } from 'constants/TableConstants';
import { tableViewRemarksDummyData } from 'constants/TableConstants';
import CustomAdvanceTable from 'components/TableCustom/CustomAdvanceTable';


function ViewRemarksDialog({ open, setOpen, remarksArray }) {
    ...
    return (
        ...
        >
            <Grid className='view-remarks-dialog-main-container'>

                <Grid className='view-remarks-cross-button'>
                ...
                <Grid className='view-remarks-content-box'>
                    <Grid className='view-remarks-text'>
                        <h4>View Remarks</h4>
                    </Grid>
                    <Grid pt={3} pb={3}>
                        <CustomAdvanceTable
                            ...
                            allColumns={tableViewRemarksAllColumns}
                            tableData={tableViewRemarksDummyData}
                            isLoading={false}
...
ViewRemarksDialog.propTypes = {
    open: PropTypes.bool.isRequired,
    setOpen: PropTypes.func.isRequired,
};

export default React.memo(ViewRemarksDialog)
